...
var methods = {
    ...
    renderPreviews: function(data){
        ...
        var template = config.roots.src + path.sep + config.paths.layouts + path.sep + config.paths.modules + path.sep + 'preview.swig';
        ...
        data.components.forEach(function(c){
            ...
            c.sub.forEach(function(s) {
                ...
                // destination
                var dest = path.join(config.roots.www, config.paths.modules, 'preview', c.name, s.name + '.html');
    ...
    renderComponents: function(data){
        ...
        // template of styleguide
        var template = config.roots.src + path.sep + config.paths.layouts + path.sep + config.paths.modules + path.sep + 'component.swig';
        ...
        data.components.forEach(function(c){
            ...
            // destination
            var dest = path.join(config.roots.www, config.paths.modules, 'components', c.name + '.html');
    ...
    renderIndex: function(data){
        ...
        // template of styleguide
        var template = config.roots.src + path.sep + config.paths.layouts + path.sep + config.paths.modules + path.sep + 'index.swig';

        // destination
        var dest = path.join(config.roots.www, config.paths.modules, 'index.html');
